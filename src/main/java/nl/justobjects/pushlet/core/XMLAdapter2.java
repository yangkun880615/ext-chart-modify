 ...
 */
class XMLAdapter2 implements ClientAdapter {
	/**
	 ...
	 * Initialize.
	 */
	public XMLAdapter2(HttpServletResponse aServletResponse) {
	 ...
	 * Initialize.
	 */
	public XMLAdapter2(HttpServletResponse aServletResponse, boolean useStrictXML) {
	...
	public void start() throws IOException {
		...
		servletRsp.setCharacterEncoding("UTF-8");
